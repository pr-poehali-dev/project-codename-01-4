...
const services = [
  {
    ...
    description:
      "Коронки (цирконий, E-max, металлокерамика), мостовидные протезы, виниры и люминиры. Контроль краевого прилегания и окклюзии, цифровая визуализация Wax-up/Mock-up.",
    mockup: "social",
  },
  {
    title: "Имплантология",
    description:
      "Индивидуальные абатменты (титан, цирконий) CAD/CAM-изготовления с учётом позиции импланта и биотипа десны. Поставка с винтами под протокол клиники.",
    mockup: "google-ads",
  },
  {
    title: "Съёмное протезирование",
    description: "Полные и частичные съёмные протезы (акрил, бюгельные каркасы), условно-съёмные решения на имплантах с перебазировкой и доработкой.",
    mockup: "email",
  },
  {
    title: "Ортодонтия",
    description:
      "Элайнеры и каппы по STL-файлам клиники, съёмные и несъёмные аппараты, окклюзионные шины при ВНЧС и бруксизме с учётом протоколов.",
    mockup: "seo",
  },
  {
    title: "Хирургические шаблоны",
    description:
      "Шаблоны под навигационную имплантацию по КТ/сканам клиники. Контроль посадки и глубины сверления, документация по позиционированию.",
    mockup: "analytics",
  },
  {
    title: "Цифровые технологии",
    description:
      "CAD/CAM-фрезерование и 3D-печать, приём цифровых оттисков (STL) без гипсовых моделей. Сокращаем сроки и снижаем число переделок.",
    mockup: "web-dev",
    badges: [
      { icon: <Shield className="w-4 h-4" />, text: "Контроль допусков" },
      { icon: <DollarSign className="w-4 h-4" />, text: "Без переделок" },
      { icon: <CheckCircle className="w-4 h-4" />, text: "Точность 99%" },
    ],
  },
]
  ...
  return (
    <section id="services" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Услуги лаборатории</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Полный спектр зуботехнических работ под клинические задачи и протоколы вашей клиники.
          </p>
        </motion.div>
